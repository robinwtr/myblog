    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact">
          ...
          <a
            target="_blank"
            href="https://github.com/robinwtr"
            class="ml-5 mr-5 iconfont icongithub"
          />
          <a
            target="_blank"
            href="https://gitee.com/robinwtr"
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold =
        new Date().getTime() - new Date("December 12,2021").getTime();
...
.home-banner {
  ...
  right: 0;
  height: 100vh;
  background: url("https://r.photo.store.qq.com/psc?/V53KcXfb1umonn4HbITu3rINxs43TczD/45NBuzDIW489QBoVep5mcQaBtLM2yTpYe999VZqnRjqLW3e23.UCR78O5Km8SpsknNgOGpEzdY7QHY1usDO6pbksfeQBV5CqlMGgsjJVV9s!/r") center
