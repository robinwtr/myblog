<template>
  <div>
    ...
    <v-card class="blog-container">
      ...
      <blockquote>
        <div>名称：robin的个人博客</div>
        <div>简介：生活平淡闲</div>
        <div>头像：https://pcsdata.baidu.com/thumbnail/9a502b052r81fba5336a6db4f47f793a?fid=4503602915668658-16051585-293982262404197&rt=pr&sign=FDTAER-yUdy3dSFZ0SVxtzShv1zcMqd-%2FAQApklAE6yqxOp7T%2FsDBxktenA%3D&expires=2h&chkv=0&chkbd=0&chkpc=&dp-logid=223179933524222521&dp-callid=0&time=1640325600&bus_no=26&size=c1600_u1600&quality=100&vuk=-&ft=video</div>
      </blockquote>
      <div class="mt-5 mb-5">
        需要交换友链的可在下方留言💖
      </div>
