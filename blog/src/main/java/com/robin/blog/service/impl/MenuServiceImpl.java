...
import com.robin.blog.dao.MenuDao;
...
import com.robin.blog.service.MenuService;
...
import static com.robin.blog.constant.CommonConst.COMPONENT;
...
public class MenuServiceImpl extends ServiceImpl<MenuDao, Menu> implements MenuService {
    ...
    public List<UserMenuDTO> listUserMenus() {
        // 查询用户菜单信息
        List<Menu> menuList = menuDao.listMenuByUserInfoId(UserUtil.getLoginUser().getUserInfoId());
        // 获取目录列表
        List<Menu> catalogList = listCatalog(menuList);
        // 获取目录下的子菜单
        Map<Integer, List<Menu>> childrenMap = getMenuMap(menuList);
