...
import com.robin.blog.dto.EmailDTO;
...
import com.robin.blog.enums.LoginTypeEnum;
import com.robin.blog.enums.RoleEnum;
import com.robin.blog.exception.ServeException;
import com.robin.blog.service.UserAuthService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.robin.blog.utils.IpUtil;
...
import static com.robin.blog.constant.MQPrefixConst.EMAIL_QUEUE;
import static com.robin.blog.constant.RedisPrefixConst.CODE_EXPIRE_TIME;
import static com.robin.blog.constant.RedisPrefixConst.CODE_KEY;
import static com.robin.blog.utils.CommonUtil.checkEmail;
import static com.robin.blog.utils.UserUtil.convertLoginUser;
...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthDao, UserAuth> implements UserAuthService {
    ...
    private UserInfoDTO getUserInfoDTO(UserAuth user) {
        ...
        // 查询账号角色
        List<String> roleList = roleDao.listRoleByUserInfoId(userInfo.getId());
        // 封装信息
